...
if __name__ == '__main__':
    ...
    train_file_list = "/mnt/nfs3/zhangjinouwen/dataset/rep/rep_middle_mel_hubert_train.txt"
    ...
    with torch.no_grad():
        for i, audio_file in tqdm(enumerate(file_list)):
            ...
            if str(path2) in audio_file:
                rep_file = audio_file.replace(str(path2), f"{args.rep_dir}/cleanmel360").split('.')[0] +'.hubert.npy'
