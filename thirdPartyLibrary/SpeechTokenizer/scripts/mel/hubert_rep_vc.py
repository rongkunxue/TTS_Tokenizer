...
if __name__ == '__main__':
    ...
    model = HubertModel.from_pretrained("facebook/hubert-base-ls960",cache_dir="/root/Github/new/TTS_Tokenizer/thirdPartyLibrary/SpeechTokenizer/checkpoint").eval().to(device)
    target_layer = "avg"
    ...
    train_file_list = "/mnt/nfs3/zhangjinouwen/dataset/rep/rep_vck_avg_hubert_train.txt"
    segment_size = 65536
