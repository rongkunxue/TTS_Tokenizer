...
if __name__ == '__main__':
    ...
    parser.add_argument('--rep_dir', type=str, default="/mnt/nfs3/zhangjinouwen/dataset/rep/wav2vec2")
    ...
    train_file_list = "/root/Github/TTS_Tokenizer/data/rep_big_wav_train.txt"
    valid_file_list = "/root/Github/TTS_Tokenizer/data/rep_big_wav_eval.txt"
