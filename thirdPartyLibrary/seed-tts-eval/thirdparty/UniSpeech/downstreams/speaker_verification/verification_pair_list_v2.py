...
parser.add_argument('--model_name',default='wavlm_large')
parser.add_argument('--checkpoint',default="wavlm_large_finetune.pth")
parser.add_argument('--scores')
parser.add_argument('--wav1_start_sr', type=0)
parser.add_argument('--wav2_start_sr', type=0)
parser.add_argument('--wav1_end_sr', type=-1)
parser.add_argument('--wav2_end_sr', type=-1)
