...
metalst="/root/Github/TTS_Tokenizer/data/generative_dataset_linterspeech.py"
...
def main(args):
    model = dac.DAC.load("/root/Github/TTS_Tokenizer/SimVQ/test/DAC/weights_24khz_8kbps_0.0.4.pth").to(DEVICE)
    model.eval()
    codebook_size = 1024
    usage = {}
