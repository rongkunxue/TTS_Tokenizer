...
from taming.data.speech_tts import speechttsTest_zh
import importlib
...
def main(args):
    ...
    speechdataset = speechttsTest_zh(data_path_str)
    ...
    with open(Path(args.ckpt_path).parent / "speedtest_zh_result.txt", 'w') as f:
